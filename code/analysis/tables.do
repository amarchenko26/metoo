...
if `run_did' == 1 {
	...
	estout A B C D E F G H using "$tables/did.tex", style(tex) replace ///
		...
		prehead("\begin{tabular}{l*{@E}{c}}" ///
		"\toprule" ///
		"\multicolumn{1}{l}{} & \multicolumn{4}{c}{|-----  \textbf{Outcome: Compensation}  -----|} & \multicolumn{4}{c}{|-----  \textbf{Outcome: Probability of Win} -----|}\\" ///
		"\multicolumn{1}{l}{} & \multicolumn{1}{c}{All} & \multicolumn{1}{c}{All} & \multicolumn{1}{c}{Employment} & \multicolumn{1}{c}{All} & \multicolumn{1}{c}{All} & \multicolumn{1}{c}{All} & \multicolumn{1}{c}{Employment} & \multicolumn{1}{c}{All} \\") ///
		posthead("\midrule") ///
