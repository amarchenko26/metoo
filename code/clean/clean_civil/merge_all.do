...
Outputs:
	- clean_cases.dta (without CT - matches original results)
	- clean_cases_w_ct.dta (with CT)
	- clean_cases_all_juris.dta (with CT, all jurisdictions)
...
/*******************************************************************************
Save merged data before processing (for CT version later)
*******************************************************************************/
...
/*******************************************************************************
********************************************************************************
FIRST PASS: Process WITHOUT CT (for clean_cases.dta - matches original results)
********************************************************************************
*******************************************************************************/
...
/*******************************************************************************
Export clean_cases.dta (WITHOUT CT - matches original results)
*******************************************************************************/
keep if eeoc==0
...
/*******************************************************************************
********************************************************************************
SECOND PASS: Process WITH CT (for clean_cases_w_ct.dta and clean_cases_all_juris.dta)
********************************************************************************
*******************************************************************************/
...
label define seasonlbl 1 "Spring" 2 "Summer" 3 "Fall" 4 "Winter", replace
label values file_season seasonlbl
...
/*******************************************************************************
Export clean_cases_all_juris.dta (WITH CT)
*******************************************************************************/
keep if eeoc==0
save "$clean_data/clean_cases_all_juris.dta", replace

/*******************************************************************************
Export clean_cases_w_ct.dta (WITH CT)
*******************************************************************************/
keep if juris=="Employment"
keep if sample_sh == 1
